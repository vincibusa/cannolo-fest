        ...
        <div className="grid md:grid-cols-2 gap-10 sm:gap-16 items-center">
          ...
          >
            <p className="text-base sm:text-lg mb-6 text-gray-700">
              <span className="font-bold text-amber-600">Sfincione Fest</span>{" "}
          ...
          >
            ...
            <div className="relative bg-white shadow-lg p-4 sm:p-6 rounded-xl border border-gray-100">
              <MotionImg
              ...
              />
              <div className="bg-gray-50 p-4 sm:p-6 rounded-lg shadow-md border border-gray-100">
                <h3 className="text-xl sm:text-2xl font-bold text-amber-600 mb-3 sm:mb-4">
                  Festival Highlights
                </h3>
