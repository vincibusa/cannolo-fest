    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <SectionTitle
          ...
          subtitle="Test your skills and taste in our exciting culinary competitions with amazing prizes"
        />

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
          {mainCompetitions.map((competition, index) => (
            <MotionDiv
              key={index}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {smallerContests.map((contest, index) => (
            <MotionDiv
              key={index}
