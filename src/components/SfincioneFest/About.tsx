  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <SectionTitle title="About Sfincione Fest" />
        ...
        <div className="grid md:grid-cols-2 gap-10 sm:gap-16 items-center">
          ...
          >
            <p className="text-base sm:text-lg mb-6 text-white/90">
              ...
              together bakers, chefs, food enthusiasts, and tourists from across
              Italy and beyond.
            </p>
            <p className="text-base sm:text-lg mb-6 text-white/90">
              ...
              is a traditional Sicilian delicacy - a thick, spongy pizza topped
              with tomatoes, onions, anchovies, and caciocavallo cheese, all
              sprinkled with breadcrumbs. What makes it special is the unique
              dough that's left to rise for hours, creating its distinctive
              texture.
            </p>
            <p className="text-base sm:text-lg mb-6 text-white/90">
              ...
              dates back to the 17th century. Each year, we welcome over 10,000
              visitors who come to experience the authentic flavors of Sicily.
            </p>
